...
El proyecto consiste en el diseño y desarrollo de un sitio web institucional para "EL CLIENTE", estructurado principalmente como una página principal (página de presentación) y un número reducido de páginas estáticas adicionales, con el objetivo de brindar presencia en línea, informar sobre servicios y facilitar el contacto.
...
| :--- | :--- |
| **Sitio Web Presencial** | Estructura pública de 5 páginas (Inicio, Nosotros, Estudios, Contacto, Privacidad). Diseño responsivo para celulares y optimización básica para buscadores web (Google). Botón flotante de WhatsApp. |
...
| **Automatización WhatsApp (Modalidad PLUS)** | Una vez procesado el archivo PDF, el sistema lo convierte a imagen (JPG/PNG) y lo envía directamente al WhatsApp del paciente para asegurar su visualización sin requerir aplicaciones extra. **Esta funcionalidad aplica para todos los pacientes del laboratorio (tanto referidos por médicos como de mostrador)**, otorgando una cobertura de entrega universal. Requiere la asignación de una **Línea Telefónica Dedicada** por parte de "EL CLIENTE", la cual podrá ser operada simultáneamente vía WhatsApp Web para dar seguimiento manual. |
...
El sitio web será entregado (desplegado a producción) en un plazo máximo e improrrogable de **[PLAZO_DE_ENTREGA]** contados a partir de la firma del presente anexo. Tras el despliegue, iniciará el **Periodo de Estabilización de 15 días naturales**, al término del cual se procederá a la firma del Acta de Aceptación Definitiva.
...
La garantía para corrección de defectos visuales, funcionales o enlaces rotos atribuibles al desarrollo será de **[DIAS_GARANTIA] naturales**, los cuales comenzarán a correr exclusivamente a partir del día siguiente a la firma del Acta de Aceptación Definitiva y una vez liquidado el pago final. Durante la fase de estabilización previa, se incluye la capacitación al personal.
...
| **Pago 2: Pago Final** | 50% | $[MONTO_PAGO_2] MXN (Netos) | A la firma del Acta de Aceptación Definitiva (Fin de Estabilización, Día 15). |
