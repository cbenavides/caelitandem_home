...
*   **Alcance Funcional:** Página web sencilla (5 secciones). Incluye Inicio, Nosotros (Cédulas), Catálogo de Estudios y Precios, Contacto (con enlace a Google Maps y botón directo a WhatsApp), y Aviso de Privacidad. Es la solución ideal para tener una presencia profesional en internet. Adicionalmente, incluye la configuración inicial de 1 campaña en Google Ads y capacitación básica para su gestión *(costos de clics: ver sección 4 de la tabla)*. *(Incluye periodo de Estabilización de 10 días; ver Condiciones Generales).* Incluye también la funcionalidad de actualización autónoma de contenidos del sitio por el propio personal *(ver funcionalidad #16)*.
*   **Alcance Tecnológico:** Incluye: **1) Posicionamiento orgánico en buscadores (SEO básico):** Optimización de la página para aparecer en resultados de Google de forma natural — sin costo de clics para LAESH. **2)** Adaptabilidad para celulares y tablets.
...
| 8 | **Carga de Resultados y Cambio Automático de Estado** | No aplica | ✅ La recepcionista sube el PDF de resultados desde un botón en el portal de recepción; el sistema **actualiza automáticamente el estado a *Resultados Listos*** sin ningún paso adicional por parte del personal. | Recepcionista, Sistema Bloc Digital |
...
| 11 | **Entrega de Resultados al Paciente en Ventanilla** | No aplica | ✅ Diseñado así: el paciente recibe sus resultados impresos directamente en ventanilla. Sin WhatsApp, sin app, sin cuenta de usuario para el paciente. | Paciente, Recepcionista |
...
| 13 | **Gestión de Usuarios y Catálogo de Estudios (Administrador)** | No aplica | ✅ El Administrador gestiona altas y bajas de médicos y recepcionistas, y mantiene actualizado el catálogo de estudios disponibles en el sistema. | Administrador |
...
| **16** | **🖊️ Cambios de contenido del sitioWeb** | ✅ El personal del laboratorio puede actualizar de forma **autónoma** los textos, precios y vigencias del sitio público `laesh.mx` desde la sección «Cambios en contenidos SitioWeb» en el portal de recepción (`laesh.mx/labadmin`), **sin necesidad de contratar al desarrollador** cada vez que cambien datos.<br>Se pueden editar las 4 secciones clave del sitio:<br>• **Promociones** (3 fichas): etiqueta de descuento, título, descripción, precio original y precio final.<br>• **Consultas Preventivas / Check Up** (3 paquetes): nombre, descripción, estudios incluidos y precio.<br>• **Diapositivas del Banner principal**: texto de cada diapositiva, etiqueta, subtítulo y duración de pantalla.<br>• **Membresía Familiar**: precio, beneficios incluidos y texto del botón de acción.<br>Cada edición muestra una **vista previa en tiempo real** antes de publicar; un solo clic en «Publicar cambios» aplica los ajustes al sitio. | ✅ Funcionalidad incluida en el Proyecto 1 (sitio público). El panel de actualización reside en el portal de recepción del Proyecto 2; para acceder a él se requiere tener contratado también el **Proyecto 2**. | Administrador LAESH, Recepcionista |
| **17** | **📱 Compatibilidad de Dispositivos** | No aplica | ✅ El **Portal Médico** (`laesh.mx/medicos`) está completamente adaptado para celulares (Android), tablets y computadoras de escritorio — el médico puede capturar órdenes y consultar resultados desde cualquier dispositivo con Chrome o Safari. El **Portal de Recepción** (`laesh.mx/labadmin`) está optimizado para computadoras de escritorio con Windows o macOS usando Google Chrome o Safari, que es el entorno habitual de trabajo de recepción. | Médico, Recepcionista |
...
| | **Fase de Capacitación y Estabilización** | ✅ 10 Días (capacitación en administración de contenidos del sitio; principalmente remota) | ✅ 10 Días presencial al momento de requerirse | Médico, Recepcionista |
...
| | **Seguridad y Respaldos** | ✅ Certificado SSL/HTTPS básico del hosting estático | ✅ SSL/HTTPS y Respaldos Automáticos continuos (gestionados vía Póliza de Servidor Mantenimiento, sugerida Año 1 / opcional post-garantía) | LAESH / Administrador |
