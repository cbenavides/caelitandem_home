...
| **Portal de Seguimiento (Médico)** | Pantalla segura donde el médico tratante consulta en tiempo real el estatus de sus pacientes referidos y descarga sus PDFs de resultados directamente. |
