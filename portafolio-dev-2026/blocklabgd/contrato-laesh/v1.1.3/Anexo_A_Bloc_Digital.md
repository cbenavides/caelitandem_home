...
*   **Módulo de Gestión de Contenidos Web (CMS Básico):** Panel integrado en el portal de recepción (`laesh.mx/labadmin`) que permite al personal del laboratorio actualizar de forma autónoma los textos, precios y descripciones del sitio web público (`laesh.mx`). Incluye gestión de: fichas de **Promociones** (badge, título, descripción, precios original y final), paquetes de **Check Up** (nombre, estudios, precio), diapositivas del **Banner/Hero** (títulos, subtítulos, textos de botones, duración) y solución de **Membresía** (nombre, precio, beneficios, CTA). Todos los cambios incluyen una **Vista Previa en Vivo** y se publican con un clic.
...
| **Gestión de Contenidos Web (CMS Básico)** | Sección "Gestión Web" accesible desde el portal de recepción (`laesh.mx/labadmin`). Permite al personal del laboratorio editar de forma autónoma el contenido del sitio público sin intervención del desarrollador: **Promociones** (badge de descuento, nombre, descripción, precio original y final con vista previa en vivo); **Check Ups** (nombre, descripción, lista de estudios y precio); **Banner/Hero** (textos del slideshow, etiquetas y duración de cada diapositiva); **Membresías** (nombre, precio, beneficios y texto CTA). Todos los cambios se publican al sitio con un clic en "Publicar Cambios". |putadoras. El portal de la clínica está diseñado para computadoras de escritorio (Windows/macOS) usando Google Chrome o Safari. |
...
*   El panel de **Gestión de Contenidos Web (CMS Básico)** permite editar y publicar correctamente los contenidos de las secciones Promociones, Check Up, Banner/Hero y Membresías del sitio público (`laesh.mx`) desde el portal de recepción, con vista previa en tiempo real.
